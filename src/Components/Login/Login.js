                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12" style={{ color: "white" }}>
                                            <div className="p-5">
                                                ...
                                                <div className='d-flex flex-column justify-content-center align-items-center' style={{backgroundColor:'white',color:'black'}}>
                                                    <span>user: selva@gmail.com</span>
                                                    <span>password: selva123</span>
                                                    </div>
                                            </div>
                                        </div>
